...
<acme:form>
	<acme:form-textarea code="administrator.auditor-request.form.label.firm" path="firm" readonly="true" />
	...
	<acme:form-submit test="${command == 'show'}" code="administrator.auditor-request.form.button.create"
